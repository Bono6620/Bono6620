...
add_action('init', function () {
    add_shortcode('fa_account', 'fa_shortcode_account');
});
...
function fa_shortcode_account(): string
{
    ...
    echo '<section class="fa-tab-toolbar"><h1>حسابي</h1></section>';
    ...
    <div class="fa-account-grid">
        <div class="fa-card fa-account-card">
            ...
            <?php if ($isAdmin): ?>
                <a class="fa-button" href="<?php echo esc_url(home_url('/family-admin/')); ?>">🛠️ لوحة التحكم</a>
            <?php endif; ?>
        </div>
